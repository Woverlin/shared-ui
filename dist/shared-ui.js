...
function lr() {
  if (Te) return F;
  Te = 1;
  var w = Se, h = Symbol.for("react.element"), j = Symbol.for("react.fragment"), y = Object.prototype.hasOwnProperty, I = w.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, $ = { key: !0, ref: !0, __self: !0, __source: !0 };
  function x(_, f, O) {
    ...
    if (_ && _.defaultProps) for (p in f = _.defaultProps, f) b[p] === void 0 && (b[p] = f[p]);
    return { $$typeof: h, type: _, key: R, ref: W, props: b, _owner: I.current };
  }
...
function fr() {
  return Oe || (Oe = 1, process.env.NODE_ENV !== "production" && function() {
    var w = Se, h = Symbol.for("react.element"), j = Symbol.for("react.portal"), y = Symbol.for("react.fragment"), I = Symbol.for("react.strict_mode"), $ = Symbol.for("react.profiler"), x = Symbol.for("react.provider"), _ = Symbol.for("react.context"), f = Symbol.for("react.forward_ref"), O = Symbol.for("react.suspense"), p = Symbol.for("react.suspense_list"), b = Symbol.for("react.memo"), R = Symbol.for("react.lazy"), W = Symbol.for("react.offscreen"), H = Symbol.iterator, Pe = "@@iterator";
    function Ce(e) {
    ...
    function Ae(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === y || e === $ || Fe || e === I || e === O || e === p || De || e === W || je || xe || ke || typeof e == "object" && e !== null && (e.$$typeof === R || e.$$typeof === b || e.$$typeof === x || e.$$typeof === _ || e.$$typeof === f || // This needs to include all possible module reference object
...
` + a[s].replace(" at new ", " at ");
      ...
      var C = e ? e.displayName || e.name : "", T = C ? Y(C) : "";
    ...
    function Ze(e, r, t, n, i) {
      {
        ...
        t !== void 0 && (ve(t), a = "" + t), Ke(r) && (ve(r.key), a = "" + r.key), qe(r) && (v = r.ref, Ge(r, i));
        for (u in r)
    ...
    function he(e, r) {
      {
        ...
        Ee[t] = !0;
        var n = "";
        e && e._owner && e._owner !== q.current && (n = " It was passed a child from " + E(e._owner.type) + "."), P(e), c('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', t, n), P(null);
      }
    }
    function _e(e, r) {
      {
    ...
    function me(e, r, t, n, i, u) {
      {
        ...
        if (D.call(r, "key")) {
          var T = E(e), d = Object.keys(r).filter(function(sr) {
            return sr !== "key";
...
var cr = X.exports;
const dr = ({ children: w, variant: h = "primary", onClick: j, ...y }) => /* @__PURE__ */ cr.jsx("button", { className: `shared-btn shared-btn-${h}`, onClick: j, ...y, children: w });
export {
  dr as Button
};
